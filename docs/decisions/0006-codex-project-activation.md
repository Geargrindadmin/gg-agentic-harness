...
Superseded in public contract by `0007-runtime-activation-adapters.md`. This ADR remains as the codex adapter implementation record.
...
5. The one-command installer activates a runtime adapter by default (`ACTIVATE_RUNTIME=codex`).
